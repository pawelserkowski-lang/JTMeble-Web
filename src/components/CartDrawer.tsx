...
export default function CartDrawer() {
  ...
  const generatePDF = async () => {
    ...
    // Symulacja opóźnienia, aby pokazać loader podczas ładowania dużych paczek
              ...
              {items.length > 0 && (
                <div className="border-t border-gray-100 dark:border-gray-800 pt-6 mt-6">
                  <div className="flex justify-between items-center mb-6">
                    <span className="text-lg font-medium text-gray-600 dark:text-gray-400">Suma częściowa (netto):</span>
                  ...
                  <div className="grid grid-cols-1 gap-3">
                    ...
                    >
                      <ShoppingBag size={18} className="mr-2" /> Przejdź do kasy
                    </button>
